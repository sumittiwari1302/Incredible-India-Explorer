/**
 * Tirupur Kumaran Explorer - Interactive Script
...
function activateTab(targetTab) {
    ...
    const tab = document.querySelector(`.tk-tab[data-tab="${targetTab}"]`);
...
function initTabNavigation() {
    ...
    if (hash) {
        const valid = ['biography', 'timeline', 'movements', 'legacy', 'gallery', 'references'];
...
function initCountUp() {
    const counters = document.querySelectorAll('.tk-count');
