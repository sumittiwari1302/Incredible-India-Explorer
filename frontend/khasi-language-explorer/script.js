document.addEventListener('DOMContentLoaded', () => {
    const playBtn = document.getElementById('khasi-play-btn');
    let utterance = null;
    let voices = [];
    ...
    if (playBtn) {
        playBtn.addEventListener('click', () => {
            ...
            utterance = new SpeechSynthesisUtterance("Khublei");
            // Khasi (kha) does not have a dedicated voice in most browsers/OSes,
