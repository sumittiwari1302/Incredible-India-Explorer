/**
 * Bharatpur Beach Profile Interactive Features
 * Handles Tab Navigation, Gallery Filtering, Lightbox Modal, and Accessibility.
 */
    ...
    filterBtns.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            galleryItems.forEach(item => {
                ...
                if (filterValue === 'all' || category === filterValue || subcategory === filterValue) {
    ...
    galleryItems.forEach(item => {
        const openLightbox = () => {
            ...
            if (img && modal && modalImg) {
                ...
                modalTitle.textContent = title ? title.textContent : 'Bharatpur Beach Visual';
