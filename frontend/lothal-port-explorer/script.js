/**
 * Lothal Ancient Port Explorer JavaScript
  ...
  function setupGalleryModal() {
    ...
    galleryItems.forEach(item => {
      item.addEventListener('click', function () {
        ...
        const caption = this.querySelector('p') ? this.querySelector('p').textContent : 'Lothal Archaeological Marvel';
