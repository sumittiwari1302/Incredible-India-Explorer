/**
 * Rashtriya Vigyan Puraskar Explorer - Interactive Script
...
function initTabNavigation() {
    const tabs = document.querySelectorAll('.vigyan-tab');
    const sections = document.querySelectorAll('.vigyan-section');
...
/**
 * Initialize accordion functionality for scientific fields
 */
...
function initScrollAnimations() {
    ...
    document.querySelectorAll('.category-card, .awardee-card, .gallery-item, .timeline-item').forEach(el => {
