...
function initQuiz() {
    const form = document.getElementById('pala-quiz-form');
...
function registerJourneyItems() {
    if (window.Journey && window.Journey.registerSearchItems) {
        window.Journey.registerSearchItems('pala-dynasty/index.html', [
            { id: 'pala-vikramashila', title: 'Vikramashila University', description: 'Ancient center of Buddhist learning.', link: 'pala-dynasty/index.html#buddhism' },
            { id: 'pala-somapura', title: 'Somapura Mahavihara', description: 'Largest Buddhist vihara in subcontinent.', link: 'pala-dynasty/index.html#buddhism' }
        ]);
    }
}
