    ...
    btn.addEventListener('click', () => {
        if (window.Journey) {
            window.Journey.toggle({
                id: id,
                explorerPage: 'frontend/white-bellied-blue-robin-explorer/index.html',
                title: 'White-bellied Blue Robin',
...
function setupJourneyIntegration() {
    if (window.Journey && window.Journey.registerSearchItems) {
        window.Journey.registerSearchItems('frontend/white-bellied-blue-robin-explorer/index.html', [
            { id: 'robin-white-bellied', title: 'White-bellied Blue Robin', description: 'A rare endemic bird of the Western Ghats.', link: '#' }
        ]);
    }
}
