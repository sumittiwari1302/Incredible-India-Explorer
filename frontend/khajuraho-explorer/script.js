// ===== Khajuraho Explorer — Page Script =====

document.addEventListener('DOMContentLoaded', function () {

  // ---------- Gallery Modal ----------
  const modal = document.getElementById('khajuraho-modal');
  const modalClose = document.getElementById('khajuraho-modal-close');
  const modalImage = document.getElementById('khajuraho-modal-image');
  const modalTitle = document.getElementById('khajuraho-modal-title');
  const modalCategory = document.getElementById('khajuraho-modal-category');
  const modalHeading = document.getElementById('khajuraho-modal-heading');
  const modalDescription = document.getElementById('khajuraho-modal-description');
  const galleryItems = document.querySelectorAll('.khajuraho-gallery-item');
  ...
  function openModal(item) {
    ...
    modalHeading.textContent = 'Khajuraho Group of Monuments';
  ...
  const bookmarkBtn = document.querySelector('.journey-bookmark-btn[data-bookmark-id="khajuraho-main"]');

  if (bookmarkBtn) {
    const bookmarkId = bookmarkBtn.getAttribute('data-bookmark-id');
    const bookmarkTitle = 'Khajuraho Group of Monuments';
