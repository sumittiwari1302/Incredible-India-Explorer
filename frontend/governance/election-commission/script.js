import { chiefElectionCommissioners } from './data.js';
import { Timeline } from './components/Timeline.js';
import { SearchBar } from './components/SearchBar.js';

document.addEventListener('DOMContentLoaded', () => {
    const appContainer = document.getElementById('cec-explorer-app');
    
    const indexedCECs = chiefElectionCommissioners.map((p, i) => ({ ...p, originalIndex: i }));
    ...
    const searchInput = document.getElementById('cec-search');
    ...
    function applyFilters() {
        ...
        const filtered = indexedCECs.filter(p => {
