/**
 * Dadasaheb Phalke Award Explorer - Interactive Script
...
function initScrollAnimations() {
    ...
    document.querySelectorAll('.instituted-item, .eligibility-item, .medal-item, .fact-item, .gallery-item, .timeline-item, .winners-table tbody tr').forEach(el => {
