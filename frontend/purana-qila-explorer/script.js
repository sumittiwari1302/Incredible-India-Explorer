/* ==========================================================================
   Purana Qila Explorer - JavaScript
...
function initSectionNavigation() {
    const sectionNav = document.getElementById('purana-section-nav');
    const navLinks = document.querySelectorAll('.purana-section-nav-link');
    const sections = document.querySelectorAll('.purana-section[id]');
...
function initGalleryInteractions() {
    const galleryItems = document.querySelectorAll('.purana-gallery-item');
    
    galleryItems.forEach(item => {
        const image = item.querySelector('.purana-gallery-image');
        
        image.addEventListener('click', function() {
            const caption = this.querySelector('.purana-gallery-caption');
...
function initParallaxEffect() {
    const heroBackdrop = document.querySelector('.purana-hero-backdrop');
