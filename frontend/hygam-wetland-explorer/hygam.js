...
function renderStats() {
    ...
    if (!grid || typeof HYGAM_INFO === 'undefined') return;

    grid.innerHTML = HYGAM_INFO.quickStats
        .map(
            stat => `
        <div class="stat-card">
...
function renderEcology() {
    ...
    if (hydroEl) hydroEl.innerHTML = `<strong>Hydrology & Flood Basin:</strong> ${ECOLOGY_HYDROLOGY.hydrology}`;
