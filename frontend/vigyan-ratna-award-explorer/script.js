/**
 * Vigyan Ratna Award Explorer - Interactive Script
...
function initScrollAnimations() {
    ...
    document.querySelectorAll('.purpose-item, .eligibility-item, .category-card, .recipient-card, .fact-item, .gallery-item, .timeline-item').forEach(el => {
