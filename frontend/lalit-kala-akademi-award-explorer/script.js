/**
 * Lalit Kala Akademi Award Explorer - Interactive Script
...
function initTabNavigation() {
    document.querySelectorAll('.lka-tab').forEach(tab => {
...
function initScrollAnimations() {
    ...
    const targets = document.querySelectorAll('.eligibility-item, .category-card, .selection-step, .awardee-card, .gallery-item, .lka-banner, .lka-content-card');
    targets.forEach(el => {
