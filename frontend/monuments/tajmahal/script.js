...
(function() {
    ...
    function applyTheme(theme) {
        ...
        try {
            ...
            localStorage.setItem('taj-mahal-theme', theme);
        } catch (e) {}
    }
    ...
    try {
        ...
        savedTheme = siteStorage.theme || localStorage.getItem('taj-mahal-theme') || 'dark';
    } catch (e) {
        savedTheme = localStorage.getItem('taj-mahal-theme') || 'dark';
    }
    ...
    const revealElements = document.querySelectorAll('.history-card, .arch-card, .highlight-card, .fact-card-monument, .gallery-item, .about-content, .unesco-content');
    ...
    console.log('%c🕌 Taj Mahal Explorer', 'font-size: 24px; font-weight: bold; color: #C9A063;');
    console.log('%cIncredible India Explorer — Taj Mahal Monument Page', 'font-size: 14px; color: #B5842A;');
    console.log('%cExplore the monument of love.', 'font-size: 12px; color: #8a7a6a;');
