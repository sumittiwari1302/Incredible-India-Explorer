...
(function() {
    ...
    function applyTheme(theme) {
        ...
        try {
            ...
            localStorage.setItem('india-gate-theme', theme);
        } catch (e) {}
    }
    ...
    try {
        ...
        savedTheme = siteStorage.theme || localStorage.getItem('india-gate-theme') || 'dark';
    } catch (e) {
        savedTheme = localStorage.getItem('india-gate-theme') || 'dark';
    }
    ...
    const revealElements = document.querySelectorAll('.history-card, .arch-card, .significance-card, .event-card, .fact-card-monument, .gallery-item, .about-content');
    ...
    galleryItems.forEach(function(item) {
        item.addEventListener('click', function() {
            ...
            if (img) {
                ...
                enlargedImg.alt = img.alt || 'India Gate image';
    ...
    console.log('%c🕊️ India Gate Explorer', 'font-size: 24px; font-weight: bold; color: #FF9933;');
    console.log('%cIncredible India Explorer — India Gate Monument Page', 'font-size: 14px; color: #C9A063;');
    console.log('%cExplore Delhi\'s iconic war memorial.', 'font-size: 12px; color: #8a7a6a;');
