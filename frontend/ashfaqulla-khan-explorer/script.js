/* =========================================================================
   Ashfaqulla Khan Explorer — Tab Navigation
   Issue #1874
   ========================================================================= */
...
(function () {
    ...
    function initTabs() {
        var tabs = document.querySelectorAll('.ak-tab');
    ...
    function initSmoothScroll() {
        var heroLinks = document.querySelectorAll('.ak-hero-cta a[href^="#"]');
        heroLinks.forEach(function (link) {
            link.addEventListener('click', function (e) {
                ...
                if (target) {
                    ...
                    if (tabId) {
                        var tabButton = document.querySelector('.ak-tab[data-tab="' + tabId + '"]');
