/**
 * Prime Minister's Award for Excellence in Public Administration Explorer - Interactive Script
...
function initScrollAnimations() {
    ...
    document.querySelectorAll('.purpose-item, .eligibility-item, .category-card, .story-card, .gallery-item, .timeline-item').forEach(el => {
