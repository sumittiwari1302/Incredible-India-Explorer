/**
 * Tagore Award for Cultural Harmony Explorer - Interactive Script
...
function initScrollAnimations() {
    ...
    document.querySelectorAll('.inspiration-item, .eligibility-item, .recipient-card, .significance-item, .gallery-item, .timeline-item').forEach(el => {
