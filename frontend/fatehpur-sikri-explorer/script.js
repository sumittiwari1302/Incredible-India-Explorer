/**
 * Fatehpur Sikri Explorer Interactive Script
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const modalImg = document.getElementById('fs-modal-img');
  const modalCaption = document.getElementById('fs-modal-caption');
  const modalOverlay = document.getElementById('fs-modal-overlay');
  ...
  function openModal(imgSrc, captionText) {
    ...
    modalImg.src = imgSrc;
    modalImg.alt = captionText || 'Fatehpur Sikri Gallery Image';
  ...
  if (bookmarkBtn) {
    const bookmarkId = bookmarkBtn.getAttribute('data-bookmark-id') || 'fatehpur-sikri-explorer-main';
