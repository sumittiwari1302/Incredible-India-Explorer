/* ==========================================================================
   Karikili Wetland Explorer Logic
...
(function () {
        ...
        btn.addEventListener('click', () => {
            if (window.Journey) {
                window.Journey.toggle({
                    id,
                    explorerPage: 'frontend/karikili-wetland-explorer/index.html',
                    title: 'Karikili Wetland',
    ...
    function setupJourneyIntegration() {
        if (window.Journey && typeof window.Journey.registerSearchItems === 'function') {
            window.Journey.registerSearchItems('frontend/karikili-wetland-explorer/index.html', [
                {
                    id: 'wetland-karikili',
                    title: 'Karikili Wetland',
                    description: 'Ramsar Site in Tamil Nadu supporting migratory waterbirds.',
                    link: '#'
                }
            ]);
        }
